...
export const OrderInfoUI: FC<OrderInfoUIProps> = memo(
  ({ orderInfo, isModal = false }) => {
    ...
    const profileOrderNumber = useMatch('/profile/orders/:number')?.params
      .number;
    ...
    return (
      <div className={styles.wrap}>
        {!isModal && (
          <span
            className={` ${styles.number} text text_type_main-medium  pb-3 pt-10`}
          >
            #{feedOrderNumber || profileOrderNumber}
          </span>
        )}
        <h3
